...
setup(
    name="travel_multi_agent_using_beeai_framework",
    version="0.1.0",
    author="Sathyaraj Medipalli",
    author_email="sathyarajmedipalli6@gmail.com",
    description="An multi-agent travel planning system using specialized agents and tools from beeai framework.",
